    ...
    public void gluTessProperty(int which, double value) {
        switch(which) {
            ...
            default:
                ...
                return;
            case 100149:
                this.avoidDegenerateTris = value != 0.0D;
                return;
        }
    ...
    public void gluGetTessProperty(int which, double[] value, int value_offset) {
        switch(which) {
            ...
            default:
                ...
                break;
            case 100149:
                value[value_offset] = this.avoidDegenerateTris ? 1.0D : 0.0D;
        }
        ...
        try {
            ...
            if (!this.fatalError) {
                ...
                if (this.boundaryOnly) {
                    ...
                    rc = TessMono.__gl_meshTessellateInterior(mesh, this.avoidDegenerateTris);
                }
